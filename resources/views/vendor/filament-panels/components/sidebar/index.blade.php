...
<aside
    ...
    <nav
        ...
        @php
        $collapsedGroupLabels = collect($navigation)
        ...
        <div id="collapsed-groups-data" data-groups="{{ json_encode($collapsedGroupLabels) }}" style="display: none;"></div>
        ...
        <script>
            ...
            if (collapsedGroups === null || collapsedGroups === 'null') {
                var collapsedGroupLabels = JSON.parse(
                    document.getElementById('collapsed-groups-data').getAttribute('data-groups')
                );
                localStorage.setItem(
                    'collapsedGroups',
                    JSON.stringify(collapsedGroupLabels),
                )
            }
