...
class Top10KecamatanChart extends ChartWidget
{
    ...
    protected static ?string $heading = 'Top 10 Kecamatan - Penerimaan ZIS Tertinggi';
    ...
    protected function getData(): array
    {
        ...
        return [
            ...
            'labels' => $topKecamatan->map(fn($item) => $item->district_name . ' (Beras: ' . number_format($item->total_beras ?? 0, 1, ',', '.') . ' kg)')->toArray(),
        ];
    }
